const SanyamRealEstateToken = artifacts.require('SanyamRealEstateToken');

let accounts;
let owner;

contract('SanyamRealEstateToken', acc => {
    accounts = acc;
    owner = accounts[0];
});
...
describe('have ownership properties', function () {
    ...
    before(async function () {
        instance = await SanyamRealEstateToken.new({from: owner});
    });
...
describe('match erc721 spec', function () {
    ...
    it('should get name, symbol, and baseTokenURI of token', async function () {
        const name = "SanyamRealEstateToken";
        const symbol = "IRET";
